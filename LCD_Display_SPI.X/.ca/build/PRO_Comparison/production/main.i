...
uint8_t ball_x_direction = 1;
uint8_t ball_y_direction = -1;


uint8_t ball_x_position = 60;
uint8_t ball_y_position = 5;

uint8_t ball_x_positions[] = {59, 60, 61};
uint8_t ball_y_positions[] = {4, 5, 6};
...
float normalized_dx = 0;
float normalized_dy = 0;
...
void update_ball_direction() {
    ...
    if(ball_x_direction == 1 && ball_x_position >= 123) {
        ball_x_direction = -1;
    } else if(ball_x_direction == -1 && ball_x_position <= 4) {
        ball_x_direction = 1;
    }

    if(ball_y_direction == 1 && ball_y_position >= 94) {
        ball_y_direction = -1;
...
void updateANDset_ball_position() {
    ...
    normalized(dx, dy);
    uint8_t change_in_x_position = (uint8_t)my_floor(normalized_dx);
    uint8_t change_in_y_position = (uint8_t)my_floor(normalized_dy);


    if(ball_x_direction == 1) {
        ball_x_position += change_in_x_position;

        ball_x_positions[0] = ball_x_positions[0] + change_in_x_position;
        ball_x_positions[1] = ball_x_positions[1] + change_in_x_position;
        ball_x_positions[2] = ball_x_positions[2] + change_in_x_position;
    } else if(ball_x_direction == -1) {
        ball_x_position -= change_in_y_position;
    ...
    if(ball_y_direction == 1) {
        ball_y_position += change_in_y_position;

        ball_y_positions[0] = ball_y_positions[0] + change_in_y_position;
        ball_y_positions[1] = ball_y_positions[1] + change_in_y_position;
        ball_y_positions[2] = ball_y_positions[2] + change_in_y_position;
...
# 902 "main.c"
    ...
    while(1) {
        ...
        drawFastHLine_Hard(ball_x_positions[1], 3, ball_y_positions[0], 0xF800);
        drawFastHLine_Hard(ball_x_positions[1], 3, ball_y_positions[1], 0xF800);
        drawFastHLine_Hard(ball_x_positions[1], 3, ball_y_positions[2], 0xF800);
    }
